...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/1.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('images/1.png') }}">
    ...
    <div class="preloading">
        <span></span>
                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        <div class="center-item" style="padding-top: 100px">
                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    {{-- <img class="" id="logo_header_mobile" alt="" src="{{ asset('images/logo/logo.png') }}"
                                        data-light="{{ asset('images/logo/logo.png') }}" data-dark="{{ asset('images/logo/logo.png') }}"
                                        data-width="30px" data-height="30px" data-retina="images/logo/logo.png"> --}}
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <form action="{{route('logout')}}" class="user-item" id="logout-form" method="post">
                                                    @csrf
                                                    <a href="{{route('logout')}}" class="" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                    ...
                    <ul>
                      <li class="product-item gap14 mb-10">
                        ...
                        <div class="flex item-center justify-between gap20 flex-grow">
                          <div class="name">
                            <a href="${link}" class="body-text"> ${item.name}
                            </a>
                          </div>
                        </div>
                      </li>
