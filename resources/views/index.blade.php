...
<main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <div class="text-center">
                  <a href="{{route('shop.index', ['categories'=>$category->id])}}" class="menu-link fw-medium">{{$category->categoryName}}</a>
                </div>
              </div>
              @endforeach
            </div><!-- /.swiper-wrapper -->
      ...
      <section class="hot-deals container">
        <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Best Seller</h2>
        <div class="row">
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{route('shop.product.details', ['product_slug'=>$bestseller->slug])}}">
                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{$bestseller->image}}" width="258" height="313" alt="{{$bestseller->name}}" class="pc__img">
                      </a>
                    </div>
                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="{{route('shop.product.details', ['product_slug'=>$bestseller->slug])}}">{{$bestseller->name}}</a></h6>
