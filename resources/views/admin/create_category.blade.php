        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.categories.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Category name" name="categoryName" tabindex="0" value="{{ old('categoryName')}}" aria-required="true" required="">
                </fieldset>
                @error('categoryName')
                    <span class="alert alert-danger text-center"> {{ $message }} </span>
                @enderror
                <fieldset class="categoryName">
