            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-transaction">
                    <tr>
                        ...
                        <td>{{$order->phone}}</td>
                        <th>Address</th>
                        <td>{{$order->city}}, {{$order->barangay}}, {{$order->sitio}}</td>
                    </tr>
                    <tr>
                        <th>Order Date</th>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{$item->product->brand->brandName}}</td>
        ...
        <div class="wg-box mt-5">
            ...
            <div class="my-account__address-item col-md-6">
                <div class="my-account__address-item__detail">
                    <p>{{$order->name}}</p>
                    <p>{{$order->city}}, {{$order->barangay}}, {{$order->sitio}}</p>
                    <p>{{$order->landmark}}</p>
                    <br>
                    ...
                    <div class="col-md-3">
                        <div class="select">
                            <select name="order_status" id="order_status">
                                <option value="processing" {{$order->status == 'ordered' ? "selected": ""}}>Processing</option>
