...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.update.slides')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">Drop your images here or select 
                                    <span class="tf-color">click to browse
