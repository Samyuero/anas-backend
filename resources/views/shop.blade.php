...
<main class="pt-90">
  ...
  <form action="{{route('shop.index')}}" id="frmfilter" method="GET">
    ...
    <input type="hidden" name="brands" id="dhnBrands">
    <input type="hidden" name="categories" id="dhnCategories">
    <input type="hidden" name="min" id="dhnMinPrice" value="{{$min_price}}">
    <input type="hidden" name="max" id="dhnMaxPrice" value="{{$max_price}}">
  </form>
